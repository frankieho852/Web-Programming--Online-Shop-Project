...
<div class="show-title">Forgot Password?</div>
	...
	<div class="field-group">
		...
		<div><input type="text" name="user-login-name" id="user-login-name" class="input-field"></div>
		<p> OR </p>
	</div>
		</div>
		...
		<div class="row">
	<div class="field-group">
	<div class="form-label">Email</label></div>
